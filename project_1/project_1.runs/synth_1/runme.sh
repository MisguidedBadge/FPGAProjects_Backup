...
HD_PWD='C:/Users/Peter/Desktop/VivadoProjects/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LEDTEST.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LEDTEST.tcl
