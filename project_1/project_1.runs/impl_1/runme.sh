...
HD_PWD='C:/Users/Peter/Desktop/VivadoProjects/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LEDTEST.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LEDTEST.tcl -notrace
