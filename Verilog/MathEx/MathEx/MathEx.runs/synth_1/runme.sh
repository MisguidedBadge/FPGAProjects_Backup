...
HD_PWD='C:/Users/Peter/Desktop/VivadoProjects/Verilog/MathEx/MathEx/MathEx.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MathEx.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MathEx.tcl
