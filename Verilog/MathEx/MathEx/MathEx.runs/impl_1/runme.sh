...
HD_PWD='C:/Users/Peter/Desktop/VivadoProjects/Verilog/MathEx/MathEx/MathEx.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MathEx.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MathEx.tcl -notrace
