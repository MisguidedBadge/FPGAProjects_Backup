...
-- Command     : write_vhdl -force -mode funcsim -rename_top Blinker_Div -prefix
--               Blinker_Div_ Clock_Divider_0_sim_netlist.vhdl
...
entity Blinker_Div_main is
  port (
    Clk_Out : out STD_LOGIC;
    Clk : in STD_LOGIC
  );
end Blinker_Div_main;

architecture STRUCTURE of Blinker_Div_main is
...
entity Blinker_Div is
  ...
  attribute NotValidForBitStream of Blinker_Div : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Blinker_Div : entity is "Clock_Divider_0,main,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of Blinker_Div : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of Blinker_Div : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of Blinker_Div : entity is "main,Vivado 2019.2";
end Blinker_Div;

architecture STRUCTURE of Blinker_Div is
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of Clk : signal is "xilinx.com:signal:clock:1.0 Clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of Clk : signal is "XIL_INTERFACENAME Clk, FREQ_HZ 100000000, PHASE 0.000, INSERT_VIP 0";
begin
inst: entity work.Blinker_Div_main
     port map (
      Clk => Clk,
      Clk_Out => Clk_Out
    );
