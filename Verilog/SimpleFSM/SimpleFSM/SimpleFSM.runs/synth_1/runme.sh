...
HD_PWD='C:/Users/Peter/Desktop/VivadoProjects/Verilog/SimpleFSM/SimpleFSM/SimpleFSM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainfsm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainfsm.tcl
