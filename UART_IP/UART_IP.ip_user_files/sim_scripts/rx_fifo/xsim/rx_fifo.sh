...
#
# Generated by Vivado on Tue Mar 03 21:04:35 -0500 2020
...
# Script info
echo -e "rx_fifo.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L fifo_generator_v13_2_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rx_fifo xil_defaultlib.rx_fifo xil_defaultlib.glbl -log elaborate.log
}
