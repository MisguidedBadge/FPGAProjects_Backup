...
#
# Generated by export_simulation on Tue Mar 03 21:29:52 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './Baud_Clock.sh' script.

./Baud_Clock.sh -reset_run
...
./Baud_Clock.sh -noclean_files

For more information on the script, please type './Baud_Clock.sh -help'.
